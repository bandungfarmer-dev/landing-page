  ...
  return (
    <>
      <div className="min-h-screen">
        <Header />
        <section className="relative mb-5 mt-2 justify-between">
          <div className="flex md:flex-row flex-col items-center px-10">
            <div className="relative rounded-xl shadow-md flex flex-col md:w-2/6 mx-auto max-w-screen-xl px-4 lg:flex lg:items-center py-4">
              <div className="top-0 bg-white max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
                <h1 className="text-xl text-black font-extrabold sm:text-2xl">
                  Bandung Farmer
                </h1>
                ...
                <div className="w-full space-y-12">
                  ...
                  <div className="md:flex bg-white shadow-md md:items-start p-2 rounded-md">
                    ...
                    <div className="mt-4 md:mx-4 md:mt-0">
                      ...
                      <p className="mt-3 text-black">
                        Jam Pengiriman Cepat dan Fleksibel. Bisa Atur Waktu
                        Sesuai Kebutuhan
                      </p>
                    </div>
                  </div>
